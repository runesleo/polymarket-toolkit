...
**Preferred:** use [GitHub private vulnerability reporting](https://github.com/runesleo/polymarket-toolkit/security/advisories/new) for this repository (if available on the repo Security tab).
