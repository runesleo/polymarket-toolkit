...
// Problem: after pUSD-era redemption, agents still need a read-only status lane for rows the
// Data API surfaces as `redeemable=true` and for low-cash strategy accounts.
